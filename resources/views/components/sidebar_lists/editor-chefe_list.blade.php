<li id="list-tree" class="list-group-item border-0">
    ...
    <ul class="list-group border-0 collapse" id="revistas">
        <li id="list-tree" class="list-group-item  border-0"><a href="{{ route('create.revista.view')}}" id="cadastrarRevista">Cadastrar</a></li>
        <li id="list-tree" class="list-group-item  border-0"><a href="{{ route('list.revista.mgmt') }}" id="gerenciarRevista">Gerenciar</a></li>
    </ul>
</li>
...
<li id="list-tree" class="list-group-item border-0">
    ...
    <ul class="list-group-item border-0 collapse" id="autores">
        <li id="list-tree" class="list-group-item  border-0"><a href="{{ route('list.autor.mgmt') }}" id="gerenciarAutor">Gerenciar</a></li>
    </ul>
</li>
...
<li id="list-tree" class="list-group-item border-0">
    ...
    <ul class="list-group-item border-0 collapse" id="avaliadores">
        <li id="list-tree" class="list-group-item  border-0"><a href="{{ route('listaAvaliadores')}}" id="gerenciarAvaliador">Gerenciar</a></li>
    </ul>
</li>
...
<li id="list-tree" class="list-group-item border-0">
    ...
    <ul class="list-group-item border-0 collapse" id="editores">
        <li id="list-tree" class="list-group-item  border-0"><a href="{{ route('lista_editores') }}" id="gerenciarEditor">Gerenciar</a></li>
    </ul>
</li>
