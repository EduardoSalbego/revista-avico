                    ...
                    <div class="card p-4 mb-4">
                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-3">
                            ...
                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                {{-- Status do parecer --}}
                                @php $revisorAtribuido = $submissao->revisoresAtribuidos->firstWhere('id', Auth::user()->revisor->id);
                        ...
                        @if($status === 'recusado')
                            ...
                            <div class="alert alert-secondary border py-2 mb-3">
                                ...
                                <p class="mb-0 small mt-1">
                                    O editor será responsável por atribuir outro revisor para este artigo.
                                </p>
                            </div>
                        @else
                            ...
                            @if(is_null($parecer->aceito_tarefa))
                                <div class="border-top pt-3 mt-2">
                                    ...
                                    <div class="d-flex gap-2">
                                        <form action="{{ route('revisor.pareceres.responderTarefa', $submissao->id) }}" method="POST">
                                            @csrf
                                            @method('PATCH')
