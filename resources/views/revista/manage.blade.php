        ...
        <table style="transition:none !important;" class="table table-borderless table-hover">
            ...
            <tbody>
                ...
                <tr scope="row">
                    ...
                    <td>{{ $revista->id }}</td>
                    <td><a href="{{route ('lista.edicoes', $revista->id)}}">{{ $revista->tituloRevista }}</a></td>
                    ...
                    <td class="text-center">
                        <a href="{{route('create.edicao', $revista->id)}}">
                    ...
                    <td class="text-center">
                        <a class="btn btn-primary" id="edit" href="{{ route('select.revista', $revista->id) }}">
                    ...
                    <div class="modal fade" id="chamados-{{ $revista->ISSNRevista }}" tabindex="-1" aria-labelledby="modal2" aria-hidden="true">
                        <div class="modal-dialog">
                            ...
                            {{-- Criar Chamado --}}
                            <div class="modal fade" id="create-chamado-{{ $revista->id }}" tabindex="-1" aria-labelledby="modal2" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header justify-content-center">
                                        ...
                                        <div class="modal-body text-center">
                                            <p class="fw-light fs-5">{{ $revista->tituloRevista }}</p>
                                            <form action="{{route('create.chamado', $revista->id)}}" method="POST">
                                                @csrf
