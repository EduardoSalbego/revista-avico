...
class CreateSubmissaoAtribuicoesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('submissao_atribuicoes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('submissao_atribuicoes');
    }
}
