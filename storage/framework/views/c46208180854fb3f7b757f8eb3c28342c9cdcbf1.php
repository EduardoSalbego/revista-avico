        ...
        <tbody>
            ...
            <tr scope="row">
                ...
                <td class="text-center">
                    <a class="btn btn-primary" id="editarEditor" href="<?php echo e(route('alterar_editor', $editor->id)); ?>">
                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                    </a>
                </td>
                <td class="text-center">
                <a class="btn btn-danger" id="removerEditor" data-bs-toggle="modal" data-bs-target="#del-modal">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Desktop\rp4-revista\resources\views/editores/manage.blade.php ENDPATH**/ ?>