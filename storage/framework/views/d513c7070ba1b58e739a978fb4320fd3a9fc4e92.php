        ...
        <table style="transition:none !important;" class="table table-borderless table-hover">
            ...
            <tbody>
                ...
                <tr scope="row">
                    ...
                    <td><a href="<?php echo e(route ('lista.edicoes', $revista->id)); ?>"><?php echo e($revista->tituloRevista); ?></a></td>
                    ...
                    <td class="text-center">
                        <a href="<?php echo e(route('create.edicao', $revista->id)); ?>">
                            <button title="Adicionar Edição" class="btn btn-md btn-primary">
                    ...
                    <td class="text-center">
                        <a class="btn btn-primary" id="edit" href="<?php echo e(route('select.revista', $revista->id)); ?>">
                    ...
                    <div class="modal fade" id="chamados-<?php echo e($revista->ISSNRevista); ?>" tabindex="-1" aria-labelledby="modal2" aria-hidden="true">
                        <div class="modal-dialog">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Deseja mesmo deletar a revista
                                                ?</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                            ...
                            <div class="modal fade" id="create-chamado-<?php echo e($revista->id); ?>" tabindex="-1" aria-labelledby="modal2" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header justify-content-center">
                                            <h5 class="modal-title text-center" id="modal2">Novo período de chamada </h5> <br>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body text-center">
                                            <p class="fw-light fs-5"><?php echo e($revista->tituloRevista); ?></p>
                                            <form action="<?php echo e(route('create.chamado', $revista->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <div class="form-group">
                                                    <label for="datainicio"><b>Data de Início</b></label>
                                                    <input type="date" class="form-control" name="datainicio" id="datainicio" style="border-radius: 0% !important;border-color: transparent !important;border-bottom: solid 2px black !important;" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="datafinal"><b>Data Final</b></label>
                                                    <input type="date" class="form-control" name="datafinal" id="datafinal" style="border-radius: 0% !important;border-color: transparent !important;border-bottom: solid 2px black !important;" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="dataavaliacao"><b>Data Final de Avaliação</b></label>
                                                    <input type="date" class="form-control" name="dataavaliacao" id="dataavaliacao" style="border-radius: 0% !important;border-color: transparent !important;border-bottom: solid 2px black !important;" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="datadivulgacao"><b>Data de Divulgação</b></label>
                                                    <input type="date" class="form-control" name="datadivulgacao" id="datadivulgacao" style="border-radius: 0% !important;border-color: transparent !important;border-bottom: solid 2px black !important;" required>
                                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Desktop\rp4-revista\resources\views/revista/manage.blade.php ENDPATH**/ ?>