            ...
            <tbody>
                ...
                <tr scope="row" class="align-middle">
                    ...
                    <?php $__currentLoopData = $submissao->artigos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artigo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e($artigo->caminhoArtigo); ?>" >
                    ...
                    <td class="col-2">
                    <?php $__currentLoopData = $submissao->artigos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artigo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($artigo->nota != 0){?>
                        <small><p class="status mb-1 text-center p-1"><?php echo e($artigo->situacao->descricaoSituacao . " (" . $artigo->nota  . ") "); ?></br></p></small>
                    <?php }else{ ?>
                    ...
                    <td>    
                        <?php if(isset($submissao->artigos[0])): ?>                   
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\rafae\OneDrive\Documentos\rp4-revista\rp4-revista\resources\views/artigo/submissoes.blade.php ENDPATH**/ ?>