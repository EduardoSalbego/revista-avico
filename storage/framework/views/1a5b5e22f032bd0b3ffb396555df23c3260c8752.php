...
<footer class="footer py-lg-4">
    <div class="container">
        <div class="row align-items-center">
            <div class="d-none d-lg-block col-lg-4 text-lg-start police"></div>
            <div class="col-lg-4 my-3 my-lg-0">
                ...
                <a class="btn btn-dark btn-social mx-lg-2" href="https://www.facebook.com/AVICOBRASIL"
                    aria-label="Facebook"><svg class="svg-inline--fa fa-facebook-f" aria-hidden="true" focusable="false"
                ...
                <a class="btn btn-dark btn-social mx--lg-2" href="https://api.whatsapp.com/message/ADJGY4UDTDAZJ1"
                    aria-label="WhatsApp"><svg class="svg-inline--fa fa-whatsapp" aria-hidden="true" focusable="false"
                ...
                <a class="btn btn-dark btn-social mx-lg-2" href="https://www.instagram.com/avicobrasil/"
                    aria-label="Instagram"><svg class="svg-inline--fa fa-instagram" aria-hidden="true" focusable="false"
                ...
                <a class="btn btn-dark btn-social mx-lg-2" href="mailto:avicobrasil@gmail.com" aria-label="Email"><svg
                        class="svg-inline--fa fa-envelope" aria-hidden="true" focusable="false" data-prefix="fas"
            ...
            <div class="d-none d-lg-block col-lg-4 text-lg-start"></div>
        </div>
    </div>
</footer>
...
<script src="https://www.gstatic.com/dialogflow-console/fast/messenger/messenger-internal.min.js?v=4"></script><?php /**PATH D:\revista-avico\resources\views/layouts/footer.blade.php ENDPATH**/ ?>