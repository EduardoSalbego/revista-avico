                    ...
                    <table id="artigos-table" style="transition:none !important;" class="table table-sm table-borderless">
                        <thead class="table-dark">
                            <th class="" scope="col">Artigo<span id="obrigatorio">* </span>
                                < <small id="obrigatorio">15MB</small>
                            </th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Desktop\rp4-revista\resources\views/artigo/submeter.blade.php ENDPATH**/ ?>