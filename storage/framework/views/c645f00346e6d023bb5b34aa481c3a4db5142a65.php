            ...
            <tbody>
                ...
                <tr scope="row">
                    ...
                    <td class="text-center">
                        <a class="btn btn-primary" id="editarAvaliador" href="<?php echo e(route('editarAvaliador', $avaliador->id)); ?>">
                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                        </a>
                    </td>
                    <td class="text-center">
                        <a class="btn btn-danger" id="removerAvaliador" data-bs-toggle="modal" data-bs-target="#del-modal">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Desktop\rp4-revista\resources\views/avaliador/manage.blade.php ENDPATH**/ ?>