...
<body id="page-top" class="bg-light">
    ...
    <main class="container py-5" style="margin-top: 80px;">
        ...
        <div class="d-flex align-items-center justify-content-center gap-3 mb-4">
            <h2 class="text-center mb-0">
                Editando: <span class="text-primary"><?php echo e($edicao->titulo ?: 'Rascunho sem título'); ?></span>
            </h2>
            <?php if($edicao->status === 'rascunho'): ?>
        ...
        <form id="form-edicao" action="<?php echo e(route('admin.edicoes.update', $edicao->id)); ?>" method="POST"
            enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            <input type="hidden" name="status" id="input-status" value="<?php echo e($edicao->status); ?>">
            ...
            <div class="card p-4 mb-4 shadow-sm border-0">
                ...
                <div class="mb-3">
                    ...
                    <?php if($edicao->imagem_capa): ?>
                        <div class="mt-2">
                            <small class="text-muted">Capa atual:</small><br>
                            <img src="<?php echo e(asset($edicao->imagem_capa)); ?>"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            const capitulosExistentes = <?php echo json_encode($edicao->capitulos, 15, 512) ?>;
...
</html><?php /**PATH /var/www/html/resources/views/admin/edicoes/edit.blade.php ENDPATH**/ ?>