...
<body class="antialiased" style="height: 100vh;">
    ...
    <nav class="navbar navbar-dark bg-dark">
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-3 sm:block">
            ...
            <a href="<?php echo e(url('/home')); ?>" id="home" class="text-sm text-gray-700 dark:text-gray-500 underline">Home</i></a>
            <?php else: ?>
            <a href="<?php echo e(route('login')); ?>" id="Btnlogin" class="text-sm text-gray-700 dark:text-gray-500 underline">Log in</a>

            <?php if(Route::has('register')): ?>
            <a href="<?php echo e(route('register')); ?>" id="Btnregistro" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Register</a>
            <?php endif; ?>
            <?php endif; ?>
        </div>
        <?php endif; ?>
...
<?php /**PATH C:\Users\rafae\OneDrive\Documentos\rp4-revista\rp4-revista\resources\views/welcome.blade.php ENDPATH**/ ?>