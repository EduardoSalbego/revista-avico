                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo e(route('avaliar.artigo', $artigo->id)); ?>" method="POST">
                        ...
                        <?php if(Session::has('message')): ?>
                            <p style="color:green;"><?php echo e(Session::get('message')); ?>
                        ...
                        <div class="form-group mb-2">
                            <a target="_blank" href="<?php echo e($artigo->caminhoArtigo); ?>">
                                <small>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Desktop\rp4-revista\resources\views/avaliador\avaliar_artigo.blade.php ENDPATH**/ ?>