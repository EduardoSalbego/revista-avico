...
<div class="">
    ...
    <div class="d-flex align-items-stretch " style="height: 94vh; width: 190px; background-color:white; ">
        <ul class="list-group " style="width: 190px; border-radius: 0; ">
            ...
            <?php endif; ?>
            <?php if(auth()->check() && auth()->user()->hasRole('avaliador')): ?>
                <?php echo $__env->make('components.sidebar_lists.avaliador_list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
            <?php if(auth()->check() && auth()->user()->hasRole('editor')): ?>
                <?php echo $__env->make('components.sidebar_lists.editor_list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
        </ul>
    </div>
</div>
<?php /**PATH C:\Users\rafae\OneDrive\Documentos\rp4-revista\rp4-revista\resources\views/components/sidebar.blade.php ENDPATH**/ ?>