                        ...
                        <div class="row g-2 mt-1">
                            ...
                            <div class="col-3">
                                <input type="radio" class="btn-check" name="role" id="role_leitor"
                                    value="leitor" <?php echo e(old('role', 'leitor') === 'leitor' ? 'checked' : ''); ?> required>
                            ...
                            <div class="col-3">
                                <input type="radio" class="btn-check" name="role" id="role_autor"
                                    value="autor" <?php echo e(old('role') === 'autor' ? 'checked' : ''); ?>>
                            ...
                            <div class="col-3">
                                <input type="radio" class="btn-check" name="role" id="role_revisor"
                                    value="revisor" <?php echo e(old('role') === 'revisor' ? 'checked' : ''); ?>>
                            ...
                            <div class="col-3">
                                <input type="radio" class="btn-check" name="role" id="role_editor"
                                    value="editor" <?php echo e(old('role') === 'editor' ? 'checked' : ''); ?>>
